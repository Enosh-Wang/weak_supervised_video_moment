...
test_caption_path = 'caption/val_2.json'
val_caption_path = 'caption/val_1.json'
train_caption_path = 'caption/train.json'
...
save_csv('activitynet_train.csv',train_caption_data)
save_csv('activitynet_val.csv',val_caption_data)
save_csv('activitynet_test.csv',test_caption_data)