...
if __name__ == '__main__':
    ...
    val_path = "/home/share/wangyunxiao/TACoS/caption/tacos_val.csv"
    test_path = "/home/share/wangyunxiao/TACoS/caption/tacos_test.csv"
    ...
    for i in tqdm(range(total_num)):
        ...
        iou = cIoU((tmp_start, tmp_end),(xmin, xmax)) # (0, 0.35)
        if iou > 0.7:
            cnt_7 += 1
        if iou > 0.5:
            cnt_5 += 1
